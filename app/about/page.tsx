    ...
    <div className="h-[100vh] bg-gray-200 flex flex-col items-center gap-10 pb-3">
      ...
      <div className="flex flex-col items-center justify-center w-[90%]   p-3 rounded-2xl gap-5 shadow bg-white">
        <p>
          ...
          accessible, stylish, and comfortable for everyone. That’s why we offer
          a wide range of products for men, women, and kids — from everyday
          basics to standout statement pieces. Our mission is to make your
          shopping experience easy, enjoyable, and inspiring. We carefully
